...
<div id="wrapper">
	...
	<div id="page">
		...
		<div id="content">
			...
			<div class="post">
				<h1 class="title"><a href="#"><a href="#">Seja Bem vindo: </a><span class="style2"><b><? print $_SESSION["usuario"]; ?></b></span><b></b></h1>
				<p class="byline">
				<div class="entry">
					<p><img src="../images/img07.jpg" alt="" width="440" height="400" />.</p>
			  </div>
		  </div>
		  <div class="post">
			  <h2 class="title">&nbsp;</h2>
			...
			<ul>
				<li>
					  ...
					  <div>
						...
						<li>
						  <div align="left"><a href="../cliente/consulta_veiculos.php">Consultar Veículos</a></div>
						</li>
						<li>
