<?php
	...
	require('cadastros/funcoes_promocoes.php');
...
{
window.location='comprar_promocao.php?id_promocao=' + id_promocao;
}
...
<link href="cadastros/estilos2.css" rel="stylesheet" type="text/css" />
</head>
<body>
<!-- start header -->
<div id="header">
...
<div id="wrapper">
	...
	<div id="page">
		...
		<div id="content">
			...
			<div class="post">
				<h1 class="title"><a href="#">Promoções</a></h1>
				<p class="byline">
				<div class="entry">
					<p align="left"> <span class="tabela"><?php 
	GeraTabela2($rs,$cab,"id_promocao","1",""); 
?> </span>
			  </div>
			</div>
		  <div class="post">
