...
<div id="wrapper">
	...
	<div id="page">
		...
		<div id="content">
			...
			<div class="post">
				<h1 class="title"><a href="#">Contato</a></h1>
				<p class="byline">
				<div class="entry">
					<p><form id="form2" method="post" action="funcoes_contato.php">
                 
					<table width="391" border="0">
                      <tr>
                        <td width="42" height="36"><span class="style11">Nome:
                            <label></label>
                        </span>                          <span class="style13">
                        <label> </label>
                        </span></td>
                        <td width="339"><input name="txtnome" type="text" class="style11" id="txtnome" size="60" /></td>
                      </tr>
                      <tr>
                        <td height="36"><span class="style13">E-mail:
                            <label></label>
                        </span>                          <label> </label></td>
                        <td><input name="txtmail" type="text" class="style11" id="txtmail" size="60" /></td>
                      </tr>
                      <tr>
                        <td colspan="2"><span class="style13">Mensagem:
                            <label></label>
                        </span>                          <label> </label></td>
                      </tr>
                      <tr>
                        <td colspan="2"><textarea name="txtmen" cols="50" rows="5" class="style11" id="txtmen"></textarea></td>
                      </tr>
                      <tr>
                        <td colspan="2">&nbsp;</td>
                      </tr>
