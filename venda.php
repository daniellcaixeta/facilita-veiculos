...
<div id="header">
	<div id="menu">
		<ul id="main">
			...
			<li><a href="registrar.php">&nbsp;&nbsp;Venda&nbsp;&nbsp;</a></li>
		</ul>
		<ul id="feed">
...
<div id="wrapper">
	...
	<div id="page">
		...
		<div id="content">
			...
			<div class="post">
				<h1 class="title"><a href="#">Venda</a></h1>
				<p class="byline">
			  <div class="entry">
					<p></p>
			  Para solicitar uma vender de um veículo, primeiramente faça seu registro no site <a href="registrar.php">clicando aqui.</a> </div>
			</div>
		  <div class="post">
			  <h2 class="title">&nbsp;</h2>
			</div>
