  ...
  if ($fl_Salvar == '1')
    {
	  ...
	  $r = InsereFuncionario($nome, $cpf, $email, $tel, $rua, $num, $bairro, $comple, $usuario, $senha, $perfi, $cidade, $estado);
	  if ($r == true)
	     {
...
<div id="wrapper">
	...
	<div id="page">
		...
		<div id="content_administrador">
			...
			<div class="post">
				<h1 class="title"><a href="../login/admin.php">Cadastrar Funcionário </a></h1>
				<p class="byline">
				<div class="entry">
					<p align="center">&nbsp;</p>
