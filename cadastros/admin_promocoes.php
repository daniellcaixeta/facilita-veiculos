...
function valida()
{
 if (document.form1.cboVeiculo.value == '-1')
   {
   alert('Selecione um Veículo!');
   document.form1.cboVeiculo.focus();
   return false;
   }
 if (document.form1.txtdesconto.value == '')
   {
   alert('Campo Desconto é obrigatorio!');
   document.form1.txtdesconto.focus();
   return false;
   }
...
if(valida()==true)
  {
	document.form1.action.value = 'cad_promocoes.php';
...
<div id="wrapper">
	...
	<div id="page">
		...
		<div id="content_administrador">
			...
			<div class="post">
				<h1 class="title"><a href="../login/admin.php">Cadastrar Promoção </a></h1>
				<p class="byline">
				<div class="entry">
					<p align="center">&nbsp;</p>
						  <form id="form1" name="form1" method="post" action="cad_promocoes.php">
		  <!--   <input type="hidden" name="txtpessoa" value="<?=$id_pessoa;?>" /> -->
              <table width="490" border="0" align="center">
                <tr>
                  <td width="56" height="28"><span class="style11">Veiculo:</span></td>
                  <td width="147"><?php
MontaCombo("cboVeiculo", $rs, "id_veiculo", "modelo","",""); 

?></td>
                  <td width="69"><div align="left"><span class="style14">Desconto:</span></div></td>
                  <td width="192"><input name="txtdesconto" type="text" class="style11" id="txtdesconto" tabindex="2" size="30" /></td>
                </tr>
                <tr>
                  <td>Data:
                  <div align="center"></div></td>
                  <td><label>
                    <input name="txtdata" type="text" id="txtdata" size="30" />
                  </label></td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
