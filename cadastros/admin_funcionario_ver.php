...
$rs=SelecionaTodos();
$cab=array('Cod','Nome', 'CPF', 'E-mail', 'Telefone', 'Usuario', 'Senha');
...
{
window.location='alte_funcionario.php?id_pessoa=' + id_pessoa;
}

function excluir(id_pessoa)
{
if(confirm('Tem certeza que deseja excluir esse Funcionário?'))
window.location='exc_funcionario.php?id_pessoa=' + id_pessoa;
}
...
<div id="wrapper">
	...
	<div id="page">
		...
		<div id="content_administrador">
			...
			<div class="post">
				<h1 class="title"><a href="../login/admin.php"> Funcionários </a></h1>
				<p class="byline">
			  <div class="entry">
			    <p align="left"><br />
<span class="tabela">
				  <?php  GeraTabela($rs,$cab,"id_pessoa","1","1"); ?>
		          </span>			  </p>
			    <p align="left"><a href="admin_funcionario.php">Cadastrar Novo Funcionário </a> <br />
		        </p>
			  </div>
			</div>
		  <div class="post">
