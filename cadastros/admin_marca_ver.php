...
{
window.location='alte_marca.php?id_marca=' + id_marca;
}

function excluir(id_marca)
{
if(confirm('Tem certeza que deseja excluir esta Marca de Veículo?'))
window.location='exc_marca.php?id_marca=' + id_marca;
}
...
<div id="wrapper">
	...
	<div id="page">
		...
		<div id="content_administrador">
			...
			<div class="post">
				<h1 class="title"><a href="../login/admin.php"> Marca de Veículo </a></h1>
				<p class="byline">
			  <div class="entry">
			    <p align="left"><br />
<span class="tabela">
				  <?php  GeraTabela($rs,$cab,"id_marca","1","1"); ?>
		          </span>			  </p>
			    <p align="left"><a href="admin_marca.php">Cadastrar Nova Marca de Veículo </a> <br />
		        </p>
			  </div>
			</div>
		  <div class="post">
