...
{
window.location='alte_cliente.php?id_pessoa=' + id_pessoa;
}

function excluir(id_pessoa)
{
if(confirm('Tem certeza que deseja excluir esse Cliente?'))
window.location='exc_cliente.php?id_pessoa=' + id_pessoa;
}
...
<div id="wrapper">
	...
	<div id="page">
		...
		<div id="content_administrador">
			...
			<div class="post">
				<h1 class="title"><a href="../login/admin.php"> Clientes </a></h1>
				<p class="byline">
			  <div class="entry">
			    <p align="left"><br />
<span class="tabela">
			    ...
			    <p align="left"><a href="admin_clientes.php">Cadastrar Novo Cliente</a> <br />
		        </p>
			  </div>
			</div>
		  <div class="post">
