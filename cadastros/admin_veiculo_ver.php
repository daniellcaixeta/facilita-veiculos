...
{
window.location='alte_veiculo.php?id_veiculo=' + id_veiculo;
}
...
<div id="wrapper">
	...
	<div id="page">
		...
		<div id="content_administrador">
			...
			<div class="post">
				<h1 class="title"><a href="../login/admin.php">Veículos </a></h1>
				<p class="byline">
			  <div class="entry">
					<p align="center">&nbsp;</p>
					<p class="tabela">
					  <?php 
	GeraTabela($rs,$cab,"id_veiculo","1","1");
?>
</p>
					<p class="tabela"><a href="admin_veiculo.php">Cadastrar Novo Veículo</a>			                              </p>
			  </div>
			</div>
		  <div class="post">
			  <h2 class="title">&nbsp;</h2>
