...
<div id="wrapper">
	...
	<div id="page">
		...
		<div id="content">
			...
			<div class="post">
				<h1 class="title"><a href="#">Quem Somos </a></h1>
				<p class="byline">
				<div class="entry">
					<p>A Facilita Car LTDA é um revendedora de veículos a pouco tempo em atividade, que se situa na rua José de Santa nº. 530 no centro da cidade de Patos de Minas. Ela presta serviços de revendas, consignações e financiamentos de veículos em geral.</p>
					<p><strong>Fotos da Empresa </strong></p>
					<table width="433" height="346" border="0">
                      <tr>
                        <td width="200"><div align="center"><img src="images/1p.jpg" alt="" width="200" height="150" onClick="MM_openBrWindow('foto_1.html','foto1','width=600,height=450')" /></div></td>
                        <td width="223"><div align="center"><img src="images/2p.jpg" alt="" width="200" height="150" onClick="MM_openBrWindow('foto_2.html','foto2','width=550,height=400')" /></div></td>
                      </tr>
                      <tr>
                        <td height="188" colspan="2"><div align="center"><img src="images/3p.jpg" alt="" width="200" height="150" onClick="MM_openBrWindow('foto_3.html','foto3','width=550,height=400')" /></div></td>
                      </tr>
                    </table>
					<p>&nbsp;</p>
			  </div>
